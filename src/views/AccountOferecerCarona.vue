  ...
  <div>
    <div class="con">
      ...
      <div class="container bg-light mt-4 py-1">
        <form @submit.prevent="salvarOferecimento()">
          <div class="row py-2 justify-content-center">
            <label for="titulo" class="col-11 form-label">
              ...
              <input type="text" class="form-control form-control-sm mt-1" id="titulo"
                placeholder="Insira um título para o seu oferecimento de carona" required minlength="3" v-model="$v.titulo.$model"
          ...
          <div class="row justify-content-center">
            <label for="descricao" class="col-11 form-label">
              ...
              <textarea class="form-control form-control-sm mt-1" id="descricao"
                placeholder="Insira uma pequena descrição de seu oferecimento de carona" rows="4">
                </textarea>
            </label>
          </div>
